...
class Student:
   def __init__(self,root):                    
      ...
      #third imag
      img2=Image.open(r"clg images\—Pngtree—captivating acrylic art mesmerizing ocean_15222733.jpg")
      ...
      main_frame.place(x=20,y=55,width=1488,height=600)
      ...
      dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman", 13), state="readonly",width=17) 
      dep_combo["values"]=("Select Department","CS","IT","Civil","Mechnical") 
      dep_combo.current(0)
      ...
      course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course, font=("times new roman", 13), state="read only",width=18 )
      course_combo["values"]=("Select Course","Bsc","BA","B.com","Msc","M.com","MA") 
      ...
      year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year, font=("times new roman", 13), state="read only" ,width=18 )
      ...
      semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester, font=("times new roman", 13), state="read only",width=18)
      ...
      studentName_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_name, width=20, font=("times new roman", 13)) 
      ...
      roll_no_entry=ttk.Entry(class_student_frame,textvariable=self.var_roll, width=20, font=("times new roman",13)) 
      ...
      gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender, font=("times new roman", 13), state="read only" ,width=18 )
      ...
      phone_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=20, font=("times new roman", 13)) 
      ...
      teacher_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=20, font=("times new roman", 13)) 
      ...
      save_btn=Button(btn_frame, text="Save",command=self.add_data,width=17, font=("times new roman",13,"bold"),bg="#57a1f8", fg="white",activebackground="red") 
      save_btn.grid(row=0,column=0)

      update_btn=Button(btn_frame, text="Update",command=self.update_data,width=17,font=("times new roman",13,"bold"),bg="#57a1f8", fg="white",activebackground="red")
      update_btn.grid(row=0,column=1)

      delete_btn=Button(btn_frame, text="Delete",command=self.delete_data,width=17, font=("times new roman", 13, "bold"),bg="#57a1f8", fg="white",activebackground="red")
      ...
      take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample", width=35, font=("times new roman",13,"bold"),bg="#57a1f8", fg="white",activebackground="red")
      take_photo_btn.grid(row=0,column=0)

      update_photo_btn=Button(btn_frame1,text="Update Photo Sample",command=self.add_data, width=35, font=("times new roman",13,"bold"),bg="#57a1f8", fg="white",activebackground="red")
      update_photo_btn.grid(row=0,column=1)


      #Right label fram
      Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Current course information",font=("times new roman",13,"bold"))
      Right_frame.place(x=750,y=10,width=720,height=580)
      
      img_right=Image.open(r"C:\Users\PRAKANSHU\Desktop\Face recognition system\clg images\bg image.png")
      ...
      search_combo=ttk.Combobox(Search_frame, font=("times new roman",12), state="read only" )
      ...
      search_btn=Button(Search_frame,text="Search",width=11, font=("times new roman", 12,"bold"),bg="#57a1f8", fg="white",activebackground="red")
      search_btn.grid(row=0,column=3, padx=4)

      showAll_btn=Button(Search_frame,text="Show All",width=11,font=("times new roman",12,"bold"),bg="#57a1f8", fg="white",activebackground="red")
